...
public class ArrayStack<T> {
    ...
    public void push(T data) {
        if (data == null) {
            throw new IllegalArgumentException("You can not insert null!");
        }
        T[] copy = (T[]) new Object[(size == backingArray.length) ? 2 * backingArray.length : backingArray.length];
    ...
    public T pop() {
        ...
        T removalNode = backingArray[size - 1];
